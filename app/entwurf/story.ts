...
export const CHAPTERS = [
  { label: "Überblick", eyebrow: "FÜR DREH- UND FRÄSTEILE", title: "CNC-Teile kalkulieren.\nIn unter 60 Sekunden.", body: "", segment: -1, side: "center", kind: "hero" },
  { label: "Das Problem", eyebrow: "DAS PROBLEM", title: "Kalkulation frisst Zeit,\ndie Ihnen woanders fehlt.", body: "Von Hand zu kalkulieren bindet Ihre besten Leute. Teil für Teil.", segment: 0, side: "right", kind: "problem" },
  { label: "Der Ablauf", eyebrow: "DER ABLAUF", title: "So läuft ein Teil\ndurch Vinyos Quote.", body: "STEP und PDF werden parallel analysiert. Die Geometrie kommt aus der STEP-Datei, Toleranzen und Oberflächenangaben aus dem PDF. Vinyos Quote ordnet alles im Modell zu, damit Sie die Ergebnisse prüfen und den Preis mit einem Klick kalkulieren können.", segment: 1, side: "left", kind: "process" },
  { label: "Präzision", eyebrow: "PRÄZISION", title: "Jede Anforderung.\nAm richtigen Detail.", body: "Form- und Lagetoleranzen, ISO-Klassen und Oberflächenangaben werden aus der Zeichnung ausgelesen und in die STEP-Geometrie eingefügt. So erhält jedes Feature die passende Anforderung. Sie können jede Zuordnung prüfen und bearbeiten.", segment: 2, side: "right", kind: "precision" },
  { label: "Kalkulation", eyebrow: "KALKULATION", title: "Ihre Maschinen.\nIhr Angebotspreis.", body: "Schnittzeiten, Rüstkosten und Material werden regelbasiert berechnet. Ihre Stundensätze, Gemeinkosten und Marge fließen in die Kalkulation ein.", segment: 3, side: "left", kind: "calculation" },
  { label: "Funktionen", eyebrow: "DER ANGEBOTSPROZESS", title: "Ein Werkzeug.\nVom Teil zum Angebot.", body: "Ihre Maschinen, Werkstoffe und Kundennormen bilden die gemeinsame Grundlage. Sie berechnen Mengenstaffeln und erstellen Angebote mit Ihrem Logo.", segment: 4, side: "right", kind: "features" },
  { label: "Kostenlos testen", eyebrow: "IHRE ENTSCHEIDUNG", title: "Ihr nächstes Teil.\nIhre erste Kalkulation.", body: "Bestätigen Sie Maschine und Rohteil, prüfen Sie den Preis und erstellen Sie Ihr Angebots-PDF. Testen Sie Vinyos Quote mit Ihren eigenen Dreh- und Frästeilen.", segment: -1, side: "left", kind: "trial" },
] as const;
...
export const STOPS = [
  ...
  { rx:.28, ry:Math.PI+.55, rz:-.24, x:-.255, y:0, scale:1.5, assembly:0, ...visibility(0) },
  { rx:-.32, ry:1.02, rz:-.25, x:.255, y:0, scale:1.8, assembly:0, ...visibility(1) },
  { rx:.3, ry:.58, rz:.15, x:-.255, y:0, scale:2.35, assembly:0, ...visibility(2) },
  { rx:-.35, ry:1.1, rz:-.32, x:.255, y:0, scale:2.35, assembly:0, ...visibility(3) },
  { rx:.32, ry:.4, rz:-.28, x:-.255, y:0, scale:2.2, assembly:0, ...visibility(4) },
  { rx:-.5, ry:1.05, rz:-.4, x:.255, y:0, scale:1.05, assembly:1, ...visibility(-1) },
];
